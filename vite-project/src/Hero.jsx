        ...
        <div className="max-w-[1480px] px-5 mx-auto max-lg:flex-col-reverse flex gap-[142px] text-start">
            <div className="">
                ...
                <button className="flex gap-4 items-center lg:mr-auto py-5 bg-[#9D9D9D] px-[101px] rounded-md font-semibold text-lg text-[#FFFFFF]">   
                    ...
                    <path d="M20.6429 1H2.35715C1.72597 1 1.21429 1.51167 1.21429 2.14286V15.8571C1.21429 16.4883 1.72597 17 2.35715 17H20.6429C21.274 17 21.7857 16.4883 21.7857 15.8571V2.14286C21.7857 1.51167 21.274 1 20.6429 1Z" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                    <path d="M1.21429 2.71436L11.5 9.00007L21.7857 2.71436" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                    <p className="">hi@yourname.com</p>
                </button>
            </div>
            <img src={img2} alt="" className="md:max-w-[400px] max-w-[240px] mx-auto md:h-[400px] h-[240px] object-cover  lg:mx-auto" />
        </div>
   </div>
  )
}
